package com.pope.rtcchat;

import android.content.Context;
import android.util.Log;

import com.pope.rtcchat.except.NotInitializedException;
import com.pope.rtcchat.inter.ISkyEvent;
...
public class SkyEngineKit {
    private final static String TAG = "SkyEngineKit";
